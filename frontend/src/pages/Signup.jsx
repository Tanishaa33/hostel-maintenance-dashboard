...
const Signup = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      // 2. Save display name in Firebase Auth profile
      await updateProfile(user, {
        displayName: name,
      });

      // 3. OPTIONAL: send extra data to your backend (NO AUTH)
      // You can still save hostel info in MongoDB here if needed
      /*
